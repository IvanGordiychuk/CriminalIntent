...
public class CrimePagerActivity extends AppCompatActivity {
    ...
    private static final String TAG ="ButtonsCrime";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mFirstButton=(Button) findViewById(R.id.first_rec_button);
        ...
        mLastButton=(Button) findViewById(R.id.last_rec_button);
